...
async function store() {
    ...
    const auraToken = fs.readFileSync(`${__dirname}/../../artifacts/halo_token.wasm`);
    const auraTokenResponse = await client.upload(account.address, auraToken, uploadFee, 'Upload halo-token contract code');
